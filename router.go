...
func newRouter() *echo.Echo {
	...
	r.PUT("/stampcard/delete/:id", controller.CardDelete)
	...
	r.PUT("/notice/read/:id", controller.NoticeReadUpdate)
	r.PUT("/letter/read/:id", controller.LetterReadUpdate)
	r.PUT("/letter/visible/:id", controller.VisibleUpdate)
